...
#
#     PHX_SERVER=true bin/talk_talk start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :talk_talk, TalkTalkWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :talk_talk, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :talk_talk, TalkTalk.Mailer,

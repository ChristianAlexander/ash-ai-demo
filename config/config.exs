...
config :talk_talk, TalkTalkWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TalkTalkWeb.ErrorHTML, json: TalkTalkWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: TalkTalk.PubSub,
  live_view: [signing_salt: "2dG1uwXS"]
...
config :talk_talk, TalkTalk.Mailer, adapter: Swoosh.Adapters.Local
